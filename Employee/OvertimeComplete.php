            ...
            <nav class="navbar navbar-default">
                <div class="container">
                    <div class="navbar-header">
                        <span class="navbar-brand">Employee Overtime Summary</span>
                    </div>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <h4>Summary Attendance : <?php echo $monthString; ?></h4>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <?php
                                                $query = "select * from overtimerecord where email='$email' and month(attendancedateot)='$month'";
                                                $result = mysqli_query($con, $query);
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ?>
                                                    <td><?php echo $row["attendancedateot"]; ?></td>
                                                    <td><?php echo $row["timeinot"]; ?></td>
                                                    <td><?php echo $row["timeoutot"]; ?></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
