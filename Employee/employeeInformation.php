...
if (array_key_exists('email', $_SESSION) && !empty($_SESSION['email'])) {
    ...
    $query = "SELECT userprofile.*,personalinformation.*,employeeinformation.employeeid,employeefinancial.acno,employeefinancial.bankname,employeeimage.img FROM 
userprofile join personalinformation on userprofile.email = personalinformation.email
                                    ...
                                    <div class="profile-user-pic">
                                        ...
                                        while ($res = mysqli_fetch_array($result)) {
                                            ...
                                            if (!empty($res["img"]) && is_file('employeepictures/' . $res["img"])) {
                                                echo"<img src='employeepictures/" . $res["img"] . "' class='img img-responsive img-thumbnail'>";
                                            } else {
                                                echo "<img src='employeepictures/default.jpg'  class='img img-responsive img-thumbnail' alt='Default Profile Pic'>";
                                            }
                                            ?>
                                        </div>
                                        <form action="upload.php" method="post" enctype="multipart/form-data">
                                            <center><input type="file" name="image" id="image" class="well well-sm">
                                            <button type="submit" class="btn btn-primary" name="bt-submit">Upload <span class="glyphicon glyphicon-upload"></span></button></center>
                                        </form>
                                </div>
                                <!-- edit form column -->
                                <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
                                    ...
                                    <form action="updateInformation.php" method="post" class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input class="form-control" value="<?php echo $res['icno']; ?>" type="text" name="icno" id="icno" onchange="setDob()">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Full Name :</label>
                                            <div class="col-lg-8">
                                                <input name="empname" id="empname" class="form-control" value="<?php echo $res['empname']; ?>" type="text"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input name="dob" id="dob" class="form-control" value="<?php echo $res['dob']; ?>" type="date" readonly/>
                                            </div>
                                        </div>
                                        <div class="form-group">
