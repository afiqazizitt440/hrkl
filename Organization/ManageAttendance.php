        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('.openDept').click(function () {
                    ...
                    $.ajax({
                        url: "selectEmployeeAttendance.php",
                        method: "post",
            ...
            //all employees attendancees
            $(function () {
                $("#allemployees").click(function () {
                    $('#tableEmployee').load('AllEmployees.php');
                });
            });
        </script>
    </head>
    <body>
            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="ManageAttendance.php">Attendance</a></li>
        ...
        <br/><br/><br/><br/>
            ...
            <div class="container-fluid" style="background:white;" >
                <h3>Employee Attendance & Overtime Details</h3>
                <div class="col-md-4" id="navarea"> <!-- left panel -->
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h4>Category</h4>
                            <div class="dropdown">
                                <button class="dropbtn" name="branchid" id="branchid">Date/Employee <span class="fa fa-caret-square-o-down"></span></button>
                            ...
                            <br/><br/>
                            <a href="#" id="allemployees"><button id="monthly" class="btn btn-info btn-md"><span class="fa fa-table"></span> Monthly</button></a><br/><br/>
                        </div>
                    </div>
                </div>
                ...
                <div id="displayAttendance" class="col-md-10">

                </div>
            </div>
        <!-- Modal Employee Attendance Details -->
        <div id="viewAttendance" class="modal fade">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="attendanceDetail">
        ...
        <!-- Modal Employee Overtime Details -->
        <div id="viewOvertime" class="modal fade">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Overtime Summary</h4>
                    </div>
                    <div class="modal-body" id="overtimeDetail">
                        <center><div class="loader"></div></center>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
