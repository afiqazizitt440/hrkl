...
if (array_key_exists('email', $_SESSION) && !empty($_SESSION['email'])) {
    ...
    $query = "select personalinformation.email,personalinformation.icno,personalinformation.empname,employeeinformation.*,employeeimage.img,userprofile.* from personalinformation
            ...
            where employeeinformation.idcom='$idcom' and userprofile.is_admin = 1 order by employeeid desc;";
...
Generic Styling, for Desktops/Laptops 
    ...
    <div class="container">
        ...
        <div class="container-fluid" style="background:white;" >
            <h2>Administrator Profile List</h2>
            <br/>
            <div align="right">
                <a href="AssignAdmin.php"><button type="button" name="add" id="add" class="btn btn-primary"><i class="fa fa-user-secret" aria-hidden="true"></i> Assign Employee as Administrator</button></a>
            </div>
            <br/>
                    ...
                    <tbody>
                        ...
                        while ($res = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                <button type="button" title="Details" name="view" id="<?php echo $res['email']; ?>" class="view_data btn btn-warning btn-sm" data-toggle="modal"  data-target="#viewEmployee"><span class="glyphicon glyphicon-menu-hamburger"></span> View Details</button>
                            </tr>
                            <?php
                        }
                        ?>
