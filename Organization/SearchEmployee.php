...
if (array_key_exists('email', $_SESSION) && !empty($_SESSION['email'])) {
    ...
    $query = "select personalinformation.email,personalinformation.icno,personalinformation.empname,employeeinformation.*,employeeimage.img,userprofile.* from personalinformation
            ...
            where employeeinformation.employeeid='$search' and employeeinformation.idcom='$idcom' and userprofile.is_admin = 0 order by employeeid asc;";
...
Generic Styling, for Desktops/Laptops 
    ...
    <div class="container">
        ...
        <div class="container-fluid" style="background:white;" >
            ...
            <br/>
            <div class="pull-left">
                <a href="EmployeeList.php"><button type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Back to Employees List</button></a>
            </div>
            <div class="row">
                ...
                <table class="table table-responsize table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($result) !== 0) {
                            echo '<center>Employee ID : <span style="font-size:20px;">' . $search . '</span> found.</center><br/>';
                            while ($res = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" title="Edit" name="edit" id="<?php echo $res['email']; ?>" class="edit_data btn btn-success btn-sm" data-toggle="modal"  data-target="#editEmployee"><span class="glyphicon glyphicon-pencil"></span></button>
                            ...
                            echo '<center>Employee ID : <span style="font-size:20px;">' . $search . '</span> not exists.</center><br/>';
                            die();
                        }
                        ?>
                    </tbody>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="jobcategory" id="jobcategory" class="form-control"/></td>
