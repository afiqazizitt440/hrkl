    ...
    <body>
        ...
        <div class = "container">
            <div class="wrapper">
                ...
                <form action="Employee/validation.php" method="post" name="Login_Form" class="form-signin">       
                    <hr class="colorgraph"><br>
                    f
                    <input type="text" class="form-control" name="email_" id="email_" placeholder="Email" required="" />
